 ...
 *************************************************/
// 播放器功能配置
var api= "http://159.75.38.125:8823";     // api地址
// var api= "http://localhost:8823";
var mkPlayer = {
    searchSong: api + "/search",
    getSongDownloadUrl: api + "/getSongDownloadUrl",
    getSongLrc: api + "/getSongLrc",
